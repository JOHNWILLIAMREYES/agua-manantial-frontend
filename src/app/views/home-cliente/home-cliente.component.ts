...
export class HomeClienteComponent {
  ...
  guardarSeccion(): void {
    ...
    seccionUpdate.home_tittle =
      this.seccionFormGroup.controls['titulo_seccion'].value;
    seccionUpdate.description =
      this.seccionFormGroup.controls['descripcion'].value;
    ...
    seccionUpdate.opacity =
      this.seccionFormGroup.controls['opacity'].value / 100;
    ...
    if (seccionUpdate.newSeccion == true) {
      ...
      this.sectionService
        .put(`update/${this.seccionSelected.section_id}`, seccionUpdate)
        .subscribe((res) => {
  ...
  addTab() {
    ...
    this.seccionSelected.image =
      'https://photos.google.com/photo/AF1QipOgIfPL9lb_joiDS-77lFlvvTT8ziPnLQZVZMC0';
  ...
  removeTab(index: number) {
    ...
    if (this.seccionSelected.section_id != null) {
      this.sectionService
        .del(`delete/${this.seccionSelected.section_id}`)
        .subscribe((res) => {
